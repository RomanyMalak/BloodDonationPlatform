...
public class AppDbContextFactory : IDesignTimeDbContextFactory<AppDbContext>
{
    public AppDbContext CreateDbContext(string[] args)
    {
       ...
       //optionsBuilder.UseSqlServer("Server=.;Database=BloodDonationDb;Trusted_Connection=True;TrustServerCertificate=True;");
        ...
        optionsBuilder.UseSqlServer("Server=db56229.databaseasp.net; Database=db56229; User Id=db56229; Password=Am5_Bo2J; Encrypt=False; MultipleActiveResultSets=True;");
