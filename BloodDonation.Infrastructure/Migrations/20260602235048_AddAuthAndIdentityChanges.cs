...
{
    /// <inheritdoc />
    public partial class AddAuthAndIdentityChanges : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RequiredBloodType = table.Column<int>(type: "int", nullable: false),
                    Urgency = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    HospitalId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CustomHospitalName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Latitude = table.Column<double>(type: "float", nullable: false),
                    Longitude = table.Column<double>(type: "float", nullable: false),
                    MedicalDocumentUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriorityResult = table.Column<int>(type: "int", nullable: false),
                    ...
                    UsedCompatibleBloodTypes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PipelineSummary = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AiMatchingLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AiMatchingLogs_BloodRequests_BloodRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BloodRequestAcceptances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BloodRequestAcceptances_BloodRequests_BloodRequestId",
                        column: x => x.BloodRequestId,
                        principalTable: "BloodRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BloodRequestAcceptances_Users_DonorId",
                        column: x => x.DonorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DonationHistories_BloodRequests_BloodRequestId",
                        column: x => x.BloodRequestId,
                        principalTable: "BloodRequests",
                        principalColumn: "Id",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DonationHistories_Users_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AiMatchingLogs_BloodRequestId",
                table: "AiMatchingLogs",
                column: "BloodRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_BloodRequestAcceptances_BloodRequestId_DonorId",
                table: "BloodRequestAcceptances",
                columns: new[] { "BloodRequestId", "DonorId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BloodRequestAcceptances_DonorId",
                table: "BloodRequestAcceptances",
                column: "DonorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DonationHistories_BloodRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DonationHistories_PatientId",
                table: "DonationHistories",
                column: "PatientId");
