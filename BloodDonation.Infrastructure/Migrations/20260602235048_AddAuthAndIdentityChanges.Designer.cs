...
namespace BloodDonation.Infrastructure.Migrations
{
    ...
    [Migration("20260602235048_AddAuthAndIdentityChanges")]
    partial class AddAuthAndIdentityChanges
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BloodDonation.Domain.Entities.DonationHistory", b =>
                {
                    ...
                    b.HasOne("BloodDonation.Domain.Entities.User", "Donor")
                        .WithMany("DonationsAsDonor")
                        .HasForeignKey("DonorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BloodDonation.Domain.Entities.User", "Patient")
                        .WithMany("DonationsAsPatient")
                        .HasForeignKey("PatientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("BloodDonation.Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("DonationsAsDonor");

                    b.Navigation("DonationsAsPatient");
